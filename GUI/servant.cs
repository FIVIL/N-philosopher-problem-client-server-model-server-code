...
namespace GUI
{
    ...
    class servant
    {
        ...
        {
            if (OnSetCondition != null)
            {
                OnSetCondition(Phphilosophercnd, index);
        ...
        private void GetData(object ObJSoc)
        {
            ...
            while (true)
            {
                ...
                if (r > 0)
                {
                    ...
                    getdeat = msg;
                    //if (msg != "okea" && msg != "okw8" && msg != "okth")
                    if (msg == "okea") set(3, map(Ip));
                    else if(msg=="okth") set(1, map(Ip));
                    else if(msg=="okw8") set(2, map(Ip));
                    else serve(msg, Ip);
                }
            }
